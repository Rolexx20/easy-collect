  ...
  return (
    <>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <Button
                ...
                variant="outline"
                className="flex-1 py-2 text-sm font-semibold rounded-lg border-purple-300 dark:border-purple-700 text-purple-700 dark:text-purple-200 bg-white dark:bg-gray-800 hover:bg-purple-50 dark:hover:bg-purple-900"
              >
      ...
      <PaymentHistoryDialog
        ...
        loan={loan}
        onPaymentReversed={onPaymentCollect}
        language={language}
      />
    </>
  );
